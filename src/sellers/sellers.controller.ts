...
export class SellersController {
  ...
  async addProducts(@Body() addProductDto: AddProductDto) {
    try {
      ...
      const resFromService =
        await this.sellersService.addProducts(newProductInfo);
  ...
  async getProductById(@Param('productId') productId: string) {
    try {
      const resFromService =
        await this.sellersService.getProductById(productId);
  ...
  async updateProduct(
    ...
    try {
      ...
      const resFromService = await this.sellersService.updateProduct(
        id,
        updateProductInfo,
      );
